...
> 状态：总体设计已完成；v2.5 阶段 3A–3E 已完成，提交 `0b5980c` 的
> Compose 联合恢复 CI 全绿，阶段 3 已关闭
> · 更新日期：2026-07-31
...
v2.5 阶段 3 的实际交付与证据见
[`v2.5/README.md`](./v2.5/README.md)及其索引的 3A–3E 实施记录；
阶段 3 已由真实 CI 关闭；阶段 4–6 与 v3.0 扩展仍是未来设计，不代表后续治理已经实现。
