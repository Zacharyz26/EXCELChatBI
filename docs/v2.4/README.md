...
| [MCP 与 Docker 全阶段演进](../MCP与Docker全阶段演进设计.md) | v2.5 阶段 3–6、安全项目和 v3.0 阶段 7–8 的扩展设计 | 总体设计完成；阶段 3 已关闭，4A–4D 功能完成 |
| [v2.5 实施入口](../v2.5/README.md) | 阶段 3–6 边界、评测纪律和当前实施入口 | 阶段 3 已关闭；下一入口为阶段 4C |
