...
| [MCP 与 Docker 全阶段演进](../MCP与Docker全阶段演进设计.md) | v2.5 阶段 3–6、安全项目和 v3.0 阶段 7–8 的扩展设计 | 总体设计完成；3A–3C 已关闭，3D 本地完成待 CI |
| [v2.5 实施入口](../v2.5/README.md) | 阶段 3–6 边界、评测纪律和阶段 3 实施入口 | 3A–3C 已关闭；3D 本地完成待 CI/Compose |
