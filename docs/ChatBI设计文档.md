...
> 健康完整视图、重连恢复与三档自主等级已由 4C/4D 实现；4C 已由真实 Compose CI 关闭，
> 4D 扩展的辅助/反馈/只读副作用门禁待更新提交验证。
...
3. **v2.5 记忆、自主性与协作 — 阶段 3A–3E 已完成**：领域无关的 schema v4、
   ...
   `2f2771f` 的真实 Compose CI 关闭；当前入口为 4D 扩展 Compose 门禁，阶段 5 为领域语义层，
   阶段 6 为自主分析和统计护栏。
...
`docs/v2.5/阶段4D实施记录.md`。新增场景的 Docker runner 结果仍待更新提交。阶段 5–6 在真实
