...
def build_server() -> MCPServer:
    ...
    server.register(
        Tool("gen_report_md", "生成 Markdown 报告", schemas.GEN_REPORT_MD_SCHEMA, tools.gen_report_md)
    )
    server.register(
        Tool("insight_summary", "生成中文洞察解读", schemas.INSIGHT_SUMMARY_SCHEMA, tools.insight_summary)
    )
    server.register(
